...
import divideAbi from 'config/abi/divide.json'
...
export const getDivideContract = (signer?: ethers.Signer | ethers.providers.Provider) => {
  return getContract(divideAbi, getDivideAddress(), signer)
}
